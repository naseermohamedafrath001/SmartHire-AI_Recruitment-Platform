              ...
              {selectedCandidates.map((candidate, index) => (
                ...
                >
                  ...
                  <div className="text-center mb-6">
                    <div className="w-16 h-16 bg-gradient-to-r from-primary-400 to-emerald-500 rounded-full flex items-center justify-center text-white font-bold text-xl mx-auto mb-3">
                  ...
                  .map((candidate, index) => (
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        <div className="w-10 h-10 bg-gradient-to-r from-primary-400 to-emerald-500 rounded-full flex items-center justify-center text-white font-bold">
                          {(candidate.analysis?.contact_info?.name || candidate.filename).charAt(0)}
                        </div>
