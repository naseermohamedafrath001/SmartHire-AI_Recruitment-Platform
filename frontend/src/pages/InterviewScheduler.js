...
const InterviewScheduler = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-emerald-50 flex items-center justify-center">
        <motion.div
          animate={{ rotate: 360 }}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-emerald-50 p-6">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        >
          <div className="flex items-center space-x-4">
            <motion.div
              ...
              className="p-3 bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-2xl"
            >
              <Calendar className="h-8 w-8 text-white" />
            </motion.div>
            <div>
              <h1 className="text-4xl font-bold bg-gradient-to-r from-emerald-600 to-emerald-600 bg-clip-text text-transparent">
                Interview Scheduler
              </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {[
            { title: 'Total Interviews', value: interviews.length, change: '+12%', icon: Calendar, color: 'from-emerald-500 to-emerald-600' },
            ...
            { title: 'Completed', value: interviews.filter(i => i.status === 'completed').length, change: '+15%', icon: CheckCircle, color: 'from-emerald-500 to-emerald-600' },
            ...
            <AnimatePresence>
              {interviews && interviews.length > 0 ? interviews.map((interview, index) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      <div className="w-12 h-12 bg-gradient-to-r from-emerald-400 to-emerald-500 rounded-full flex items-center justify-center text-white font-bold">
