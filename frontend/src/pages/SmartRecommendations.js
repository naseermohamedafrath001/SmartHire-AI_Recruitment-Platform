...
const SmartRecommendations = () => {
  ...
  const getTypeColor = (type) => {
    switch (type) {
      case 'candidate': return 'from-emerald-500 to-emerald-600';
      case 'process': return 'from-emerald-500 to-emerald-600';
      case 'market': return 'from-green-500 to-green-600';
      case 'diversity': return 'from-orange-500 to-orange-600';
      case 'prediction': return 'from-cyan-500 to-rose-600';
      case 'workflow': return 'from-teal-500 to-teal-600';
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-emerald-50 to-teal-100 flex items-center justify-center">
        <motion.div
          animate={{ rotate: 360 }}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-emerald-50 to-teal-100 p-6">
        ...
        >
          <div className="flex items-center space-x-4">
            <motion.div
              ...
              className="p-3 bg-gradient-to-r from-emerald-500 to-rose-600 rounded-2xl"
            >
              <Sparkles className="h-8 w-8 text-white" />
            </motion.div>
            <div>
              <h1 className="text-4xl font-bold bg-gradient-to-r from-emerald-600 via-rose-600 to-emerald-600 bg-clip-text text-transparent">
              ...
              >
                ...
                <div className="mb-4 p-3 bg-emerald-50 rounded-lg">
                  <div className="flex items-start space-x-2">
                    ...
                    <div>
                      <p className="text-sm font-medium text-emerald-900">AI Reasoning</p>
                      <p className="text-sm text-emerald-700">{rec.reasoning}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="px-4 py-2 bg-gradient-to-r from-emerald-500 to-rose-600 text-white rounded-lg text-sm font-medium flex items-center space-x-2"
                  >
        ...
        {filteredRecommendations.length === 0 && (
          ...
          >
            <motion.div
              ...
              className="inline-block p-4 bg-gradient-to-r from-emerald-100 to-rose-100 rounded-2xl mb-4"
            >
