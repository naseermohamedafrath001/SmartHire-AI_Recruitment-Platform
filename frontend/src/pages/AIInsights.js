      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        >
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-4xl font-bold bg-gradient-to-r from-emerald-600 via-emerald-600 to-rose-600 bg-clip-text text-transparent">
        ...
        {insights && (
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center p-6 bg-gradient-to-br from-emerald-50 to-teal-100 rounded-xl">
              ...
              <div className="text-center p-6 bg-gradient-to-br from-emerald-50 to-rose-100 rounded-xl">
                <div className="text-3xl font-bold text-emerald-600 mb-2">
