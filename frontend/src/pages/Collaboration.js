        ...
        >
          <div className="flex items-center space-x-4">
            <motion.div
              ...
              className="p-3 bg-gradient-to-r from-teal-500 to-emerald-600 rounded-2xl"
            >
          ...
          >
            ...
            <div className="glass-card p-6">
                ...
                {activeUsers.map((user, index) => (
                  ...
                  >
                    <div className="relative">
                      <div className="w-10 h-10 bg-gradient-to-r from-teal-400 to-emerald-500 rounded-full flex items-center justify-center text-white font-bold text-sm">
                        {user.avatar}
                      </div>
              ...
              <motion.button
                ...
                className="w-full mt-4 p-3 border-2 border-dashed border-gray-300 rounded-xl text-gray-500 hover:border-teal-300 hover:text-teal-600 transition-colors flex items-center justify-center space-x-2"
              >
                ...
                <AnimatePresence>
                  {notifications.map((notification, index) => (
                    <motion.div
                      ...
                      animate={{ opacity: 1, x: 0 }}
                      exit={{ opacity: 0, x: 10 }}
                      className="flex items-start space-x-3 p-3 bg-gradient-to-r from-teal-50 to-emerald-50 rounded-lg"
                    >
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-4">
                  <AnimatePresence>
                    {messages.map((message, index) => (
                      ...
                      >
                        <div className="w-8 h-8 bg-gradient-to-r from-teal-400 to-emerald-500 rounded-full flex items-center justify-center text-white font-bold text-xs">
                          {message.userAvatar}
                        </div>
                  ...
                  <div className="flex items-center space-x-3">
                    <div className="flex-1 relative">
                      <input
                        ...
                        className="w-full p-3 pr-12 border border-gray-200 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                      />
                    ...
                    <motion.button
                      ...
                      className="p-3 bg-gradient-to-r from-teal-500 to-emerald-600 text-white rounded-xl disabled:opacity-50 disabled:cursor-not-allowed"
                    >
          ...
          >
            ...
            <div className="glass-card p-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  { icon: Calendar, label: 'Schedule', color: 'from-emerald-500 to-emerald-600', action: () => candidates.length > 0 && scheduleInterview(candidates[0]) },
                  ...
                  { icon: Star, label: 'Favorite', color: 'from-emerald-500 to-emerald-600', action: () => candidates.length > 0 && markAsFavorite(candidates[0]) }
                ].map((action, index) => {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {candidates.slice(0, 6).map((candidate, index) => (
                  <motion.div
                    ...
                    className="p-4 border border-gray-200 rounded-xl hover:border-teal-300 cursor-pointer transition-all"
                  >
                    <div className="flex items-center space-x-3">
                      <div className="w-12 h-12 bg-gradient-to-r from-teal-400 to-emerald-500 rounded-full flex items-center justify-center text-white font-bold">
