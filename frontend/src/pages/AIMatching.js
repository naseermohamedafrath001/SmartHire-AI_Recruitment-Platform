      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        >
          <div className="inline-flex items-center space-x-3 mb-4">
            ...
            <h1 className="text-5xl font-bold bg-gradient-to-r from-emerald-600 via-rose-600 to-emerald-600 bg-clip-text text-transparent">
              AI-Powered Matching
            </h1>
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div>
              ...
              <input
                ...
                className="w-full p-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"
              />
            </div>
          ...
          <div className="mt-6">
            ...
            <textarea
              ...
              rows={4}
              className="w-full p-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all resize-none"
            />
          </div>
                ...
                {matchResults.map((candidate, index) => (
                  ...
                  >
                    ...
                    <div className="flex items-start space-x-4 mb-4">
                      <div className="w-16 h-16 bg-gradient-to-r from-emerald-400 to-rose-400 rounded-2xl flex items-center justify-center text-white font-bold text-xl">
