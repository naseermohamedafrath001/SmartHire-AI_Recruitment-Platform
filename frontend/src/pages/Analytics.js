...
const Analytics = () => {
  ...
  const COLORS = ['#10b981', '#0d9488', '#059669', '#0f766e', '#065f46'];
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <motion.div
                  className={`p-3 rounded-xl ${metric.color === 'primary' ? 'bg-primary-100' :
                ...
                >
                  <Icon className={`h-6 w-6 ${metric.color === 'primary' ? 'text-primary-600' :
          ...
          {chartTypes.map((chart) => {
            ...
            return (
              <motion.button
                ...
                className={`flex items-center space-x-2 px-4 py-2 rounded-lg font-medium transition-all duration-200 ${selectedChart === chart.id
